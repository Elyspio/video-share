...
export const RoomApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        deleteRoom: async (idRoom: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/rooms/{idRoom}`
        ...
        updateRoomState: async (idRoom: string, state: RoomState, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/rooms/{idRoom}/state/{state}`
                .replace(`{${"idRoom"}}`, encodeURIComponent(String(idRoom)))
...
export class RoomApi extends BaseAPI {
    ...
    public createRoom(body: string, options?: AxiosRequestConfig) {
        return RoomApiFp(this.configuration).createRoom(body, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteRoom(idRoom: string, options?: AxiosRequestConfig) {
        return RoomApiFp(this.configuration).deleteRoom(idRoom, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getRoom(idRoom: string, options?: AxiosRequestConfig) {
        return RoomApiFp(this.configuration).getRoom(idRoom, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateRoomState(idRoom: string, state: RoomState, options?: AxiosRequestConfig) {
        return RoomApiFp(this.configuration).updateRoomState(idRoom, state, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const VideoApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        convertVideo: async (idVideo: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/videos/{idVideo}/convert`
        ...
        deleteVideo: async (idVideo: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/videos/{idVideo}`
                .replace(`{${"idVideo"}}`, encodeURIComponent(String(idVideo)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export class VideoApi extends BaseAPI {
    ...
    public addVideo(filename: string, container: string, file: any, options?: AxiosRequestConfig) {
        return VideoApiFp(this.configuration).addVideo(filename, container, file, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public convertVideo(idVideo: string, options?: AxiosRequestConfig) {
        return VideoApiFp(this.configuration).convertVideo(idVideo, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteVideo(idVideo: string, options?: AxiosRequestConfig) {
        return VideoApiFp(this.configuration).deleteVideo(idVideo, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getVideo(idVideo: string, options?: AxiosRequestConfig) {
        return VideoApiFp(this.configuration).getVideo(idVideo, options).then((request) => request(this.axios, this.basePath));
    }
