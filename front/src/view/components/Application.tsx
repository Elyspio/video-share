...
function Application() {
	...
	React.useEffect(() => {
		dispatch(silentLogin()).then((logged) => {
			if (logged.payload === false) dispatch(push(routes.notLogged));
		});
	}, [dispatch]);
	...
	const drawer = withDrawer({
		component: (
			<Routes>
				<Route path={routes.notLogged} element={<RequireLogin route={"rooms"} />} />
